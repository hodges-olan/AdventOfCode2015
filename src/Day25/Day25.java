...
public class Day25 {
    ...
    private static double nextCode(double input) {
        double nextCode = (input * 252533) % 33554393;
        return nextCode;
    }

    private static double getCode(double i, int x, int y) {
        int tableX = 1, tableY = 1;
        while(tableX != x || tableY != y) {
            if(tableY == 1) {
                tableY = tableX + 1;
                tableX = 1;
            } else {
